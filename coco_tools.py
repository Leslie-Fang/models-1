...
# Refer from https://github.com/tensorflow/models/blob/master/research/object_detection/metrics/coco_tools.py
...
def ExportSingleImageGroundtruthToCoco(image_id,
  ...
  """
  groundtruth_boxes 2D (num of bbox, 4)
  groundtruth_classes 1D (num of bbox, 4)
  """
